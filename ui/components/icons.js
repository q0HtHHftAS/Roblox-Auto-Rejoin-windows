...
const ICONS={
  ...
  copy:'<path d="M8 8.5C8 6.61438 8 5.67157 8.58579 5.08579C9.17157 4.5 10.1144 4.5 12 4.5H15.5C17.3856 4.5 18.3284 4.5 18.9142 5.08579C19.5 5.67157 19.5 6.61438 19.5 8.5V12C19.5 13.8856 19.5 14.8284 18.9142 15.4142C18.3284 16 17.3856 16 15.5 16H12C10.1144 16 9.17157 16 8.58579 15.4142C8 14.8284 8 13.8856 8 12V8.5Z" stroke="currentColor" stroke-width="1.5"/><path d="M15.5 19.5H8.5C6.61438 19.5 5.67157 19.5 5.08579 18.9142C4.5 18.3284 4.5 17.3856 4.5 15.5V8.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>',
...
export function applySolarStaticIcons(root=document){
  ...
  replaceSvg(root,'#nav [data-nav-group="tool"] .nav-group-icon svg','settings','nav-icon');
