...
class HybridAccountTests(unittest.TestCase):
    ...
    def test_ui_separates_graphics_and_hides_toggle_controls(self):
        ...
        self.assertIn("Argus Log", html)
        self.assertIn('id="logs-clear"', html)
        self.assertIn('id="log-summary"', html)
        self.assertIn('id="logs-timeline"', html)
        self.assertIn('id="logs-inspector"', html)
        self.assertIn('id="logs-raw"', html)
        self.assertIn('data-log-filter="important"', html)
        self.assertIn('data-log-filter="info"', html)
        self.assertIn('data-log-filter="debug"', html)
        self.assertIn('data-log-filter="raw"', html)
        self.assertIn("RUNTIME_EVENTS", html)
        self.assertIn("/runtime/events?limit=350", html)
        self.assertIn("function normalizeLogEvent(e)", html)
        self.assertIn("function renderLogInspector(items)", html)
        self.assertIn("event-info", html)
        self.assertIn("event-state", html)
        self.assertIn("event-success", html)
        self.assertIn("event-warn", html)
        self.assertIn("event-error", html)
        self.assertIn("event-recovery", html)
        self.assertIn("LOG_FILTER=localStorage.getItem('rg_log_filter')||'important'", html)
        self.assertIn("metadata hidden", html)
        self.assertIn("function clearLogs()", html)
        self.assertIn("function confirmClearLogs()", html)
        self.assertIn("cardIcon('log')", html)
        self.assertIn("Clear Argus log", html)
        self.assertIn("Removes all saved log lines.", html)
        self.assertIn("/logs/clear", html)
        self.assertNotIn("confirm('Clear Argus log", html)
        ...
        queue_section = html.split('id="view-queue"', 1)[1].split('id="view-logs"', 1)[0]
        for button_id in (
            "game-save",
            "game-reset",
            "fps-save",
        ...
        self.assertIn(".btn.good.settings-dirty{background:#123322;border-color:#2f9f67;color:#9ff0bd", html)
        ...
        self.assertEqual(html.count('class="btn-icon" aria-hidden="true"'), 16)
        self.assertIn('id="close-all-roblox-btn"><svg class="btn-icon"', html)
        self.assertIn('id="add-btn"><svg class="btn-icon"', html)
        self.assertIn('id="logs-refresh"><svg class="btn-icon"', html)
        self.assertIn('id="logs-clear"><svg class="btn-icon"', html)
